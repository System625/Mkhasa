    ...
    <div className="relative">
      ...
      {!hideList.some((x) => pathname.includes(x)) && (
        ...
        >
          {user ? (
            <>
              <h2 className="pb-4 text-xl font-bold tracking-tight capitalize      ">
                {user?.username}
              </h2>
              ...
              {!pathname
                ...
                <Link
                  to="/account"
                  className="inline-block py-4       z-[9999]"
                  onClick={() => setExpand(false)}
                >
                  My Account
                </Link>
            ...
            <Link to="/login">
              <Button
                className="w-full font-bold text-app-red bg-app-ash text-nowrap       z-[9999]"
                onClick={toggle}
              >
                Login
              </Button>
